...
mydir = 'C:\\Users\\kayle\\Documents\\Morton-REU\\case_study_sims_bottlenecks\\bottleneck_2\\Simulations\\q_engelmannii'
setwd(mydir)
...
for(x in 1:2) {
  for(i in 1:length(list_files)) {
    ...
    if(x==1) { #high intensity sampling
      sample_size_equal = c(100,100,100,100) #high intensity
      sample_size_prop = as.numeric(table(temp_genind@pop)*0.02)#high intensity
...
setwd('C:\\Users\\kayle\\Documents\\Morton-REU\\case_study_sims_bottlenecks\\bottleneck_2\\R-scripts')
