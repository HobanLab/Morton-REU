...
mean(results_highMig_highSamp_equal)
mean(results_highMig_highSamp_prop)

round(results_lowMig_highSamp_equal,3)
round(results_lowMig_highSamp_prop,3)
mean(results_lowMig_highSamp_equal)
mean(results_lowMig_highSamp_prop) #overall mean = 0.937

mean(total_alleles_highMig)
mean(total_alleles_lowMig)
...
mean(results_highMig_lowSamp_equal)
mean(results_highMig_lowSamp_prop)

round(results_lowMig_lowSamp_equal,3)
round(results_lowMig_lowSamp_prop,3)
mean(results_lowMig_lowSamp_equal)
mean(results_lowMig_lowSamp_prop)
