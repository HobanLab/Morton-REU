...
my_dir = "C:\\Users\\kayle\\Documents\\Morton-REU\\Attempt3_full_factorial_10rep\\Simulations\\lowMig_highSamp"
setwd(my_dir)
...
#10 replicates
results_lowMig_highSamp_equal = array(0, dim = c(9,10))
...
#9 scenarios (each with 5 populations)
#10 replicates
results_lowMig_highSamp_prop = array(0, dim = c(9,10))
