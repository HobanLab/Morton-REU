...
#total alleles
total_alleles_highMig_lowSamp_equal = array(0, dim = c(9,100))
#expected heterozygosity
heterozygosity_highMig_lowSamp_equal = array(0, dim = c(9,100))
...
for(i in 1:length(scenarios)) {
  ...
  for(j in 1:length(list_files)) {
    ...
    total_alleles_highMig_lowSamp_equal[i,j] = total_alleles
    
    #heterozygosity
    sum_temp_genind = summary(temp_genind)
    heterozygosity_highMig_lowSamp_equal = sum_temp_genind$Hexp
...
#total alleles
total_alleles_highMig_lowSamp_equal
mean(total_alleles_highMig_lowSamp_equal)
#heterozygosity
heterozygosity_highMig_lowSamp_equal
mean(heterozygosity_highMig_lowSamp_equal)
...
#total alleles
total_alleles_highMig_lowSamp_prop = array(0, dim = c(9,100))
#heterozygosity expected
heterozygosity_highMig_lowSamp_prop = array(0, dim = c(9,100))
...
for(i in 1:length(scenarios)) {
  ...
  for(j in 1:length(list_files)) {
    ...
    total_alleles = ncol(temp_genind@tab)
    total_alleles_highMig_lowSamp_prop[i,j] = total_alleles
    
    #heterozygosity
    sum_temp_genind = summary(temp_genind)
    heterozygosity_highMig_lowSamp_prop = sum_temp_genind$Hexp
...
#total alleles
total_alleles_highMig_lowSamp_prop
mean(total_alleles_highMig_lowSamp_prop)
#heterozygosity
heterozygosity_highMig_lowSamp_prop
mean(heterozygosity_highMig_lowSamp_prop)
...
save(heterozygosity_highMig_lowSamp_equal, heterozygosity_highMig_lowSamp_prop, file="heterozyogsity_highMig_lowSamp.Rdata")
#***********************************************************************************************************************************************************
